...
<p className='head-text mt-12 md:mt-16 lg:mt-5'>Changelog</p>
  <p className='text-muted-foreground text-lg max-w-xl'>New updates and improvements to Leapflow.</p>
    </div>
<Changelog/>
<div className='flex justify-center items-center  bg-black py-10 mx-auto mt-20 z-40' >
<Brand/>
</div>
  </div>
})