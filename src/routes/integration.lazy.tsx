  ...
  return (
    <div className="w-full min-h-screen bg-[var(--bg-hero)]">
      ...
      <div className="flex flex-col justify-center items-center">
        <p className="bg-gradient-to-r from-[#6C38FF] to-[#B59AFF] bg-clip-text text-transparent text-base font-semibold tracking-widest uppercase">
          Integrations
        </p>
        <div className="flex justify-center items-center gap-y-4 flex-col">
          ...
          <p className="text-[#8A8F98] max-w-2xl text-center font-medium ">
