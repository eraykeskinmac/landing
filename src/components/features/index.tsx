...
export default function FeaturesSection() {
  return (
    <MagicContainer className="min-h-screen w-full max-w-sm sm:max-w-3xl lg:max-w-6xl 2xl:max-w-7xl mx-auto my-6 md:mt-24 lg:mt-28 grid grid-cols-1 md:grid-cols-4 gap-y-5 gap-x-0 md:gap-x-5 px-2">
