  ...
  return (
    <div className="w-full h-full flex flex-col rounded-[inherit] overflow-hidden">
      ...
      <div className="w-full h-full flex flex-col justify-evenly items-center gap-3 p-3 font-manrope">
        <div className="w-full bg-background/40 rounded-lg p-3 flex flex-col justify-center cursor-pointer hover:scale-105 duration-200 transition-transform transform-gpu ease-in-out">
