...
export default function IntegrationGrid() {
  return (
    <MagicContainer className="w-full max-w-xl sm:max-w-3xl lg:max-w-6xl 2xl:max-w-7xl mx-auto my-6 md:mt-24 lg:mt-28 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-y-5 gap-x-0 md:gap-x-5 px-2">
      <MagicCard className="col-span-2 md:col-span-1 lg:col-span-2 border w-full rounded-2xl p-0 flex flex-col max-h-[27rem]">
        <Grid1 />
      </MagicCard>
